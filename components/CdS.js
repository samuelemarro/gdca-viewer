export default function CdS () {
    return (
        <>
            <p>Lettera informatica n. █████ della Divisione Amministrativa</p>
            <p>
            ...
            <p>
                Si ricorda inoltre che il termine per fare questa richiesta coincide con l&apos;inizio del Collegio di Sangue.
            </p>
        </>
    )
}